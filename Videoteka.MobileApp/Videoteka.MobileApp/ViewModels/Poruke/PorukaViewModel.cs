...
namespace Videoteka.MobileApp.ViewModels.Poruke
{
    public class PorukaViewModel:BaseViewModel
    {
        ...
        public async Task Init()
        {
            if (KlijentID > 0)
            {
                ...
                var list = await _porukeService.Get<List<Model.Models.Poruka>>(searchRequest);
        ...
        public async Task OznaciKaoProcitanu(Poruka poruka)
        {
            ...
            porukaRequest.RezervacijaFilmaId = poruka.RezervacijaFilmaId;
